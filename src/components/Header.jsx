            ...
            <div className='container'>
                <div className='header-logo'>
                    ...
                    <div className='header-location'>
                        <div className='category'>
                            <PiNotepadLight size={30} color='#ffffff' />
                        ...
                        <div className='location'>
                            <CiLocationOn size={30} color='#ffffff' />
                            <div className='container-item'>
                                <div className='item'>
                ...
                <div className='header-menu'>
                    ...
                    <div className='header-menu__item'>
                        <HeaderItem Icon={"AiOutlinePhone"} label={'Gọi mua hàng ' + '1800 2097'} />
                        <HeaderItem Icon={"BiTimeFive"} label={'Cửa hàng gần bạn'} />
                        <HeaderItem Icon={"PiBusDuotone"} label={'Tra cứu đơn hàng'} />
